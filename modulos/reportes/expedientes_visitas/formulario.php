...
<div class="col-md-12 grid-margin stretch-card">
    ...
    <div class="box-body">
        <table style="width:100%">
            ...
            <tr> 
                <td class="tdi">Fecha Inicial</td>
                <td class="tdc">:</td>
                <td class="tdd">
                    <input type="date" name="fecha_inicial" id="fecha_inicial"  value="" title="Fecha Inicial" placeholder="Fecha Inicial" maxlength="30" required/>
                </td>            
            </tr>
            ...
            <tr> 
                ...
                <td class="tdc">:</td>
                <td class="tdd">
                    <input type="date" name="fecha_final" id="fecha_final"  value="" title="Fecha Final" placeholder="Fecha Final" maxlength="30" required/>
                </td>            
            </tr>
