        ...
        grid = $.addGrid("#grid",
                {
                    ...
                    cols: [
						...
						{display: 'SIGLA', name: 'sigla', width: 200, align: 'left'}, 
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <tr> 
                ...
                <td class="tdc">:</td>
                <td class="tdd">
                    <input type="text" id="bnombre" name="nombre" title="Nombre" placeholder="Nombre" maxlength="30" value="" />
                </td>            
            </tr>
            <tr> 
                <td class="tdi">Sigla</td>
                <td class="tdc">:</td>
                <td class="tdd">
                    <input type="text" id="bsigla" name="sigla" title="Sigla" placeholder="Sigla" maxlength="5" value="" />
                </td>            
            </tr>
                                        </table>
      ...
      <div class="modal-body">
          ...
          <form id="formulario">
            ...
            <tr> 
                ...
                <td class="tdc">:</td>
                <td class="tdd">
                    <input type="text" id="nombre" name="nombre" title="Nombre" placeholder="Nombre" maxlength="30" value="" />
                </td>            
            </tr>
            <tr> 
                <td class="tdi">Sigla</td>
                <td class="tdc">:</td>
                <td class="tdd">
                    <input type="text" id="sigla" name="sigla" title="Sigla" placeholder="Sigla" maxlength="5" value="" />
                </td>            
            </tr> 
            <tr>
