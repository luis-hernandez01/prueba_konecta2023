    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <tr> 
                ...
                <td class="tdc">:</td>
                <td class="tdd">
                    <input type="text" id="bnombre" name="nombre" title="Nombre" placeholder="Nombre" maxlength="200" value="" />
                </td>            
            </tr>
                                        </table>
      ...
      <div class="modal-body">
          ...
          <form id="formulario">
            ...
            <tr> 
                ...
                <td class="tdc">:</td>
                <td class="tdd">
                    <input type="text" id="nombre" name="nombre" title="Nombre" placeholder="Nombre" maxlength="200" value="" />
                </td>            
            </tr> 
            <tr>
