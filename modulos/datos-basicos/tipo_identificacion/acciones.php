...
class Tipo_identificacion extends formulario_basico {

    function validar() {
        $v = new Validation($_POST);
		$v->addRules('nombre', 'Nombre', array('maxLength' => 100) );
    ...
    function getSQL() {
        ...
        $sql = "SELECT * FROM tipo_identificacion WHERE 1=1  $s ORDER BY id ASC ";
        return $sql;
    }
...
$accion = ACCION;
$f = new Tipo_identificacion("tipo_identificacion", "id", true);
$f->$accion();
?>