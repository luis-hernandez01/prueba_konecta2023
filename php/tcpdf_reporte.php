...
class TCPDF_REPORTE extends TCPDF {
    ...
    public function Header() {
        ...
        $this->Image("img/logo_empresa.jpeg", $margins[left] + 5, $top + 3, 47);
        $this->SetFont('times', '', 10);
        $this->MultiCell($line_width - $margins[right] - $margins[left] - 59, 40, "{$l1} {$fecha} \n{$l2}\n{$l3}\n{$l4}", 0, "L", 0, 1, $margins[left] + 56, $top + 3);
